...
<div>
    ...
    <div id="main">
        ...
        <div id="lastuse-table" v-show="category.lastuse">
            ...
            style="width: 100%;"
            max-height="500">
              <el-table-column prop="docName" label="Document name" width="150" align="center"></el-table-column>
              <el-table-column prop="owner" label="Document owner" width="150" align="center"></el-table-column>
              <el-table-column prop="lastUseTime" label="Last modified time" width="200" align="center"></el-table-column>
              <el-table-column prop="auth" label="Permissions" width="150" align="center"></el-table-column>
              <el-table-column label="Operation" width="300" align="center">
                    <template slot-scope="scope">
                        <el-button
                        size="mini"
                        @click="handleExplore(scope.$index, scope.row)">Check</el-button>
                        <el-button
                        size="mini"
        ...
        <div id="create-table" v-show="category.create">
            ...
            max-height="500">
              <el-table-column prop="docName" label="Document name" width="150" align="center"></el-table-column>
              <el-table-column prop="lastUseTime" label="Last modified time" width="200" align="center"></el-table-column>
              <el-table-column prop="shareAmount" label="Share number" width="150" align="center"></el-table-column>
              <el-table-column prop="userData" label="Shared members" width="300" align="center">
                <template slot-scope="scope">
            ...
            max-height="500">
              ...
              <el-table-column label="Operation" width="300" align="center">
                <template slot-scope="scope">
                  <el-button
                      size="mini"
                      @click="handleExplore(scope.$index, scope.row)">View</el-button>
                  <el-button
                      size="mini"
        ...
        <div id="button-group">
            <el-button type="primary" @click="showUploadDialog">upload<i class="el-icon-upload el-icon--right"></i></el-button>
        </div>
        <el-dialog title="upload files" :visible.sync="uploadDialogVisible">
            <el-upload
            ref="upload"
            action=""
          ...
          <div slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="uploadFile">Submit</el-button>
          </div>
        </el-dialog>
    </div>
</div>
