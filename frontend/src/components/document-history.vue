  ...
  <div>
    ...
    <div id="editor">
      <div id="title-group" align="left">
        <el-button type="text" icon="el-icon-arrow-left" style="font-size:20px;color:black;margin-left:20px;" @click="toDocumentEdit">Return to document editing </el-button>
        <el-tag style="margin-left:30px;">Time: {{timestamp}}</el-tag>
      </div>
